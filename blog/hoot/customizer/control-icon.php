	...
	public function render_content() {
		...
		switch ( $this->type ) {
			...
			case 'icon' :
				...
				<div class="hoot-customizer-control-icon-picked hoot-flypanel-button" data-flypaneltype="icon"><i class="<?php echo esc_attr( $iconvalue ) ?>"></i><span><?php _e( 'Select Icon', 'responsive-brix' ) ?></span></div>
				<div class="hoot-customizer-control-icon-remove"><i class="fas fa-ban"></i><span><?php _e( 'Remove Icon', 'responsive-brix' ) ?></span></div>
